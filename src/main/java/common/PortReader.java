...
public class PortReader extends SentenceAdapter implements SerialPortEventListener {

    public static final Logger log = LogManager.getLogger(PortReader.class);
    ...
    public void serialEvent(SerialPortEvent event) {
        if(event.isRXCHAR() && event.getEventValue() > 0){
            ...
            try {
                ...
                String data = SerialTest.getInstance().getSerialPort().readString(event.getEventValue());
