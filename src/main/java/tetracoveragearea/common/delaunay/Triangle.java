...
public class Triangle implements Serializable {
	...
	/**
	 * Считает окружность, описанную возле треугольника
	 * @return
	 */
	Circle circumcircle() {
	...
	public void setAcTriangle(Triangle canext) {
	...
	public List<Point> getRingPoints() {
	...
	public Point getCentroid() {
		return new Point(
				...
				(getA().getZ() + getB().getZ() + getC().getZ()) / 3
		);
	}
	...
	public double getArea() {
		...
		double ab = GeometryUtils.getDistance(getA(), getB());
